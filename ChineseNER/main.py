...
flags.DEFINE_string("ckpt_path",    "ckpt-test",      "Path to save model")
flags.DEFINE_string("summary_path", "summary",      "Path to store summaries")
flags.DEFINE_string("log_file",     "train-test.log",    "File for log")
flags.DEFINE_string("map_file",     "maps2.pkl",     "file for maps")
flags.DEFINE_string("vocab_file",   "vocab.json",   "File for vocab")
flags.DEFINE_string("config_file",  "config_file",  "File for config")
flags.DEFINE_string("script",       "conlleval",    "evaluation script")
flags.DEFINE_string("result_path",  "result",       "Path for results")
flags.DEFINE_string("emb_file",     "wiki_100.utf8", "Path for pre_trained embedding")
flags.DEFINE_string("train_file",   os.path.join("data", "total_train.txt"),  "Path for train data")
flags.DEFINE_string("dev_file",     os.path.join("data", "1213_entity_train.txt"),    "Path for dev data")
flags.DEFINE_string("test_file",    os.path.join("data", "entity_train.txt"),   "Path for test data")
...
def evaluate_line():
    ...
    with tf.Session(config=tf_config) as sess:
        ...
        while True:
            ...
            #     logger.info(e)
            #     with open('/users/anlei/desktop/111.csv', 'r')as f:
            #
            #         data = csv.reader(f)
            #         sent = []
            #         for item in data:
            ...
            #             num += 1
                        ...
                        #     otherStyleTime1 = now1.strftime("%Y-%m-%d %H:%M:%S")
